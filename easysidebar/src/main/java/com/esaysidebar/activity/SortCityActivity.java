...
import com.esaysidebar.utils.Statusbar;
...
public class SortCityActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = Statusbar.StatusBarLightMode(this);
        Statusbar.StatusBarLightMode(this, i);
        Window window = this.getWindow();
        Statusbar.MIUISetStatusBarLightMode(window, true);
...
//      window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    private void initViews() {
        ...
        iv_back = (LinearLayout) findViewById(R.id.mGoback_Lin);
    ...
    private void setAdapter() {
        ...
        adapter = new SortAdapter(this, SourceDateList, LocationCity);
    ...
    private void initEvents() {
        ...
        sideBar.setOnSelectIndexItemListener(new EasySideBar.OnSelectIndexItemListener() {
            ...
            public void onSelectIndexItem(int index, String value) {
                //该字母首次出现的位置
                position = adapter.getPositionForSection(value.charAt(0));
