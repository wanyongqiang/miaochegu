...
public class YTGProcessFragment_ViewBinding<T extends YTGProcessFragment> implements Unbinder {
  protected T target;

  @UiThread
  public YTGProcessFragment_ViewBinding(T target, View source) {
    this.target = target;
