...
public class WTGProcessFragment_ViewBinding<T extends WTGProcessFragment> implements Unbinder {
  protected T target;

  @UiThread
  public WTGProcessFragment_ViewBinding(T target, View source) {
    this.target = target;
