...
public class SelectPhotoFourActivity_ViewBinding<T extends SelectPhotoFourActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public SelectPhotoFourActivity_ViewBinding(final T target, View source) {
    this.target = target;
